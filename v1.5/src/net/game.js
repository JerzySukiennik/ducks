...
import { REQ, WIRE_KIND, decodeInputWindow, seqNewer } from './protocol.js';
...
export function createNetGame(deps) {
  ...
  // (0 is the starter machine). Client side only; a host reads its own world.
  ...
  return {
    ...
    crankProgressOf(key) {
      const p = crankPct.get(key | 0);
      return p === undefined ? null : p / 100;
    },
    isClient,
