...
export const EVENT_MAP = {
  ...
  duck_pit: "pit.consumeEvents() returned a 'duck'",
...
export function createGameAudio(deps) {
  ...
  function noteContainerEvents() {
    ...
    let spills = 0;
    for (let i = 0; i < list.length; i++) if (list[i].type === 'spill') spills++;
  ...
  function pollLoops() {
    ...
    loops.setAmbient('radio', true, boothAt);
  }
