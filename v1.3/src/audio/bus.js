...
// The ship list. Every file in assets/audio/ appears here exactly once, and
// src/audio/wire.js maps every one of these to a game event. The two lists are
// cross-checked at boot (debugAudioCoverage), which is gate F-D.
export const CLIPS = [
  'achievement', 'box_spill', 'broom', 'build_demolish', 'build_invalid',
  'build_place', 'build_rotate', 'buy_fail', 'buy_ok', 'cart_loop', 'cash',
  'conveyor_loop', 'crank_click', 'duck_impact', 'duck_pit', 'duck_rare',
